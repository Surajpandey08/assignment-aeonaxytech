  ...
  return (
   <section>
    ...
    <div className='flex justify-between px-2 pt-8 pb-4 border-b-2'>
        <div className='px-8  flex justify-evenly text-xs font-normal gap-2 md:gap-4 md:text-sm md:font-semibold text-blue-950'>
            <a href="">Help</a>
            <a href="">Contact</a>
            <a href="">Fees</a>
            <a href="">Security</a>
        ...
        <div>
            <img className='w-8' src="https://png.pngtree.com/png-vector/20210129/ourmid/pngtree-the-national-flag-of-india-png-image_2845292.jpg" alt="" />
        </div>
    </div>
